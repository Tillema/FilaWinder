...
// When settings are changed, the EEPROM need to be updated as well. The EEPROM
// version is set below. Change this value whenever you update the firmware.
#define EEPROM_VERSION 1.0 